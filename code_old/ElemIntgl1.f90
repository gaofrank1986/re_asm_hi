...
!       write(debug_file_id,*) '   DDSF_src=',DDSF_src
        ...
        !! output info for python post - progressing 
        write(200,1010) ielem,inode,NODj,is,result0
1010    FORMAT(4i5,8f10.8) 
...
!
        ...
        END DO
		write(209,*) ielem,inode,nodj,is
        write(210,1000) result0
